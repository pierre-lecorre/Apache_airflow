...
VARIABLE_SUFFIX = "daily_report"

# Define the queries and corresponding sheet names (used in both tasks)
queries = [
    {"query_variable": f"{VARIABLE_SUFFIX}_7_days_agg_totals", "sheet_name": "7 days - agg totals"},
    {"query_variable": f"{VARIABLE_SUFFIX}_7_days_all_data", "sheet_name": "7 days - all data"},
    {"query_variable": f"{VARIABLE_SUFFIX}_7_days_cat_totals", "sheet_name": "7 days - cat totals"},
    {"query_variable": f"{VARIABLE_SUFFIX}_MTD_agg_totals", "sheet_name": "MTD - agg totals"},
    {"query_variable": f"{VARIABLE_SUFFIX}_MTD_all_data", "sheet_name": "MTD - all data"},
    {"query_variable": f"{VARIABLE_SUFFIX}_MTD_cat_totals", "sheet_name": "MTD - cat totals"},
    {"query_variable": f"{VARIABLE_SUFFIX}_YTD_agg_totals", "sheet_name": "YTD - agg totals"},
    {"query_variable": f"{VARIABLE_SUFFIX}_YTD_all_data", "sheet_name": "YTD - all data"},
    {"query_variable": f"{VARIABLE_SUFFIX}_YTD_cat_totals", "sheet_name": "YTD - cat totals"},
    {"query_variable": f"{VARIABLE_SUFFIX}_query_pi", "sheet_name": "query_pi"},
    {"query_variable": f"{VARIABLE_SUFFIX}_Dataset_LookerStudio", "sheet_name": "Dataset - LookerStudio"},
    {"query_variable": f"{VARIABLE_SUFFIX}_warehouse_10", "sheet_name": "Warehouse - 10"},
    {"query_variable": f"{VARIABLE_SUFFIX}_warehouse_15", "sheet_name": "Dataset - 15"},
    {"query_variable": f"{VARIABLE_SUFFIX}_warehouse_CZ", "sheet_name": "Dataset - CZ"}
